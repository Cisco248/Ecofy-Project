import 'package:e_wms_mobile/provider/locate_provider.dart';
...
class _LocateBottomState extends State<LocateBottom> {
  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<LocateProvider>(context);
    double boxSize = 16;
    double spaceSize1 = 5;
          ...
          Row(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    '${provider.changeDistance(null)} km',
                    style: Theme.of(context).textTheme.headlineMedium,
                  ),
                  Text(
                    provider.changeStatus(null).toString(),
                    style: Theme.of(context).textTheme.bodyLarge,
                  ),
                ],
              ),
